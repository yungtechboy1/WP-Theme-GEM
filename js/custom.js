            ...
            appendHTML: function() {
            	if($(object).is('img')) {
            		...
            		if(settings.animateIn) {    
            			...
            			$(object).wrap('<div class="slickhoverWrapper" style="position: relative; max-width:100%; overflow:hidden; border-radius: 50%; display:inline-block; background:'+settings.color+';"></div>');
            			$(icon).insertBefore($(object));
            		}
            		else
            			$(object).wrap('<div class="slickhoverWrapper" style="position: relative; max-width:100%; overflow:hidden; border-radius: 50%; display:inline-block; background:url('+settings.icon+') center center no-repeat '+settings.color+';"></div>');        
            	}
            },
